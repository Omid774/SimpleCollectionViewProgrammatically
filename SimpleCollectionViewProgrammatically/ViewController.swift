...
//  SimpleCollectionViewProgrammatically
//
//  Created by Omid Heydarzadeh on 11/14/24.
//
...
//        collectionView.contentInset = UIEdgeInsets(top: 200, left: 20, bottom: 20, right: 20)
